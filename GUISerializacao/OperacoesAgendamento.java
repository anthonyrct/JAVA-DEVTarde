...
public class OperacoesAgendamento {
    ...
    public void atualizarAgendamento(int linhaSelecionada, String data, String hora, String usuarios,
            String descricao) {
    ...
    private void atualizarTabela() {
        ...
        for (Agendamento agendamento : agendamentos) {
            tableModel.addRow(new Object[] { agendamento.getData(), agendamento.getHora(), agendamento.getUsuario(),
